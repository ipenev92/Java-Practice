...
public class BaseHamburger {
    ...
    public BaseHamburger(String name, String breadRoll, String meat, double price) {
        this.name = name;
    ...
    public double calculatePrice() {
        ...
        System.out.println("Initial price for " + this.name + " on a " + this.breadRoll + " roll with " + this.meat + ": " + this.price);
